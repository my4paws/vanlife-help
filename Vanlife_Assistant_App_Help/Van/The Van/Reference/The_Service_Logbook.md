...
category: "Van"
type: "Reference"
tags: [help, vanlife-assistant, van, service, history, logbook, maintenance, repairs, upgrades, reference]
...
## The Maintenance Schedule Link

Tap the **wrench icon** in the toolbar to open the [[The_Maintenance_Schedule|Maintenance Schedule]] as a sheet without leaving the Logbook. After logging a service entry, this lets you immediately update the task's "last performed" date and odometer in one flow.
