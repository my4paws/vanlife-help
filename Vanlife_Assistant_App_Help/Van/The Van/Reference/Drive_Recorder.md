...
- **Recording** (red dot) — GPS data is actively being captured at high precision
- **Armed** (orange) — The recorder is running but GPS hasn't acquired yet, or is in breadcrumb mode
