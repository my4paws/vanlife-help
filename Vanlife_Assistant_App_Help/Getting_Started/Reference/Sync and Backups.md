...
* **Money:** Export your entire ledger or specific monthly reports as a `.CSV` file for Excel or Numbers. 👉 *See [[Exporting Your Data (CSV)|CSV Export Service]]*
* **Trips:** Export your recorded drives as `.GPX` files to use in other mapping software. 👉 *See [[GPX Import|GPX Import & Export]]*
...
👉 *For more advanced technical details, check out [[CloudKit_Sync_Behaviour|CloudKit Sync Behaviour]].*