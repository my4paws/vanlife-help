---
title: "Welcome to Vanlife Assistant Help Desk"
aliases:
  - "help desk"
  - "help home"
  - "help index"
...
type: "Index"
tags: [help, vanlife-assistant, getting-started, index, hub, welcome]
last_updated: "2026-03-08"
---

# 🚐 Vanlife Assistant Help Desk

Use the search bar above to find any topic instantly, or browse by section below.

---

## 💡 Concepts — How the App Thinks
...
### Getting Started
New to the app, or setting up a new device? Start here.
- [[Welcome to Vanlife Assistant]] — what the app does and how the modules fit together
- [[Onboarding Guide]] — walkthrough of the first-time setup screens
- [[Permissions Explained]] — why each permission is needed and what happens without it
- [[Sync and Backups]] — iCloud sync, offline-first design, and how to restore to a new phone

### 🚐 Van & Fleet
Your vehicle profile, health, and history.
- [[Van_Index|Van Index]] — all Van tab articles

### ⚡ Smart Van
HomeKit integration, modes, automations, and the Van Brain.
- [[SmartVan_Index|Smart Van Index]] — all Smart Van articles

### 📦 Manifest
Inventory management, zones, containers, payload, and QR labels.
- [[Understanding_the_Manifest|Manifest Index]] — all Manifest articles

### 🗂️ Glovebox
Secure document storage, border mode, and the document scanner.
- [[Glovebox Index]] — all Glovebox articles

### 🗺️ Trips & Navigation
Expeditions, check-ins, drive recording, border detection, and Schengen.
- [[Trips/Index|Trips Index]] — all Trips articles

### 📍 Spots & Route Planning
The Spots Vault, Trip Planner, datasets, and route conditions.
- [[Spots/Index|Spots Index]] — all Spots articles

### 💰 Money & Runway
Ledger, accounts, scenarios, budgets, and financial forecasting.
- [[Money/Index|Money Index]] — all Money articles

### 🌤️ Weather
The solar tracker, route forecasts, and SmartVan weather automations.
- [[Trips/Weather/Index|Weather Index]] — all Weather articles

### 🎙️ Voice Assistant
Everything you can ask and how to phrase it.
- [[Voice_Index|Voice Assistant Index]] — all Voice articles

### 📋 Whiteboard
Task lists, reminders, and location-based triggers.
- [[Whiteboard/Index|Whiteboard Index]] — all Whiteboard articles

### ⚙️ Settings
Units, notifications, privacy, crew, fleet, and data management.
- [[Settings/Index|Settings Index]] — all Settings articles

### 🚨 Emergency Mode
The SOS dashboard, smart dialling, and setup.
- [[Trips/Emergency_Mode/Index|Emergency Mode Index]] — all Emergency Mode articles

### 🔬 Advanced
CloudKit sync, background behaviour, permissions, and data integrity.
- [[Advanced/Index|Advanced Index]] — all Advanced articles
