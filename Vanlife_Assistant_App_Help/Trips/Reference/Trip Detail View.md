...
* **Country count** — the total number of countries visited, updated live as you add check-ins and the [[Border Crossing Detection]] engine logs transitions.
* **Flag ribbon** — a flowing row of flag emoji for every country you visited, in the order they were detected.
* **📷 Photo button** — opens the [[^Smart Notebook (Photo Gallery)|Smart Notebook]] to browse every photo taken during the trip.
* **Spending button & total** — tapping "Spending" opens the full [[^The Spending Sheet|Spending Sheet]]; the running total is always visible at a glance on the right.
...
| **Check-ins** | Total [[Checkins\_and\_Timeline|Check-ins]] saved to this expedition   |

### Expedition Driving
If you used the [[Drive\_Recorder|Drive Recorder]] during this trip, three driving stats appear below the grid:
...
Beneath these, the full **[[Elevation\_Charts|Expedition Profile]]** chart renders — the continuous elevation-over-distance silhouette stitched together from every drive.
...
### Check-in Cards
Each [[Checkins\_and\_Timeline|Check-in]] appears as a bold card showing:
...
Tap any card to open the full [[TripCheckInDetailView|Check-in Detail View]]. Long-press for a context menu with **Edit** and **Delete** options.
...
Tap **Spending** in the Trip Header Card to open a dedicated financial summary for the expedition. This sheet pulls all transactions from your [[Adding\_Transactions|Money Ledger]] whose dates fall within the trip's date range.
...
* [[Elevation\_Charts|Elevation Charts (Expedition Profile)]]
