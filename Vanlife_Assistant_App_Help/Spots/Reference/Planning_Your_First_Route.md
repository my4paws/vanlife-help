---
title: "Tutorial: Planning Your First Route"
aliases:
  - "plan first route"
  - "first route tutorial"
  - "how to plan a route"
  - "route planning tutorial"
  - "create route tutorial"
  - "add waypoints tutorial"
  - "trip planner tutorial"
category: "Spots"
type: "Tutorial"
tags: [help, vanlife-assistant, spots, tutorial, trip-planner, route, waypoints]
...
## Step 3: Add Your First Destination

You can add the next stop two ways:

**Option A — Drop a pin manually:**
Long-press your destination area on the map and tap **Add as Custom Waypoint** again.

**Option B — Pick a Spot from the Vault:**
If you have a Spot pack loaded, tap any green/teal/red/indigo pin on the map to open its Reconnaissance sheet, then tap **Add to Route** at the bottom.
...
## Step 4: Add More Stops (Optional)
...
## Step 6: Scout for Spots Along the Route
...
## Step 8: Navigate to Your First Stop
...
## Step 10: Save Your Draft (Optional)
